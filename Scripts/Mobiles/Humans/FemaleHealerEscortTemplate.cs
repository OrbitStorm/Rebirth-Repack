...
{
	public class FemaleHealerEscortTemplate : BaseCreature
	{
		public FemaleHealerEscortTemplate() : base( AIType.AI_Melee, FightMode.Agressor, 10, 1, 0.45, 0.8 )
		{
		...
		public FemaleHealerEscortTemplate( Serial serial ) : base( serial )
		{
		}
