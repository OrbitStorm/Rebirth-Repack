	...
	{ 
		...
		{ 
			...
			{ 
				...
				Add( new GenericBuyInfo( typeof( TinkerTools ), 16, 20, 0x1EBC, 0 ) );

				Add( new GenericBuyInfo( typeof( Pickaxe ), 32, 20, 0xE86, 0 ) );
				// TODO: Sledgehammer
				Add( new GenericBuyInfo( typeof( Hammer ), 28, 20, 0x102A, 0 ) );
				Add( new GenericBuyInfo( typeof( SmithHammer ), 10, 20, 0x13E3, 0 ) );
				Add( new GenericBuyInfo( typeof( ButcherKnife ), 8, 20, 0x13F6, 0 ) );
			} 
		} 
