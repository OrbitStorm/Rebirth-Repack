...
namespace Server.Mobiles
{
	...
	public class DummyMace : Dummy
	{
		...
		public DummyMace() : base(AIType.AI_Melee, FightMode.Closest, 15, 1, 0.2, 0.6)
		{
			...
			war.Movable = true;
			war.Crafter = this;
			war.Quality = CraftQuality.Regular;
			AddItem( war );
			...
			cht.Crafter = this;
			cht.Quality = CraftQuality.Regular;
			AddItem( cht );
			...
			chl.Crafter = this;
			chl.Quality = CraftQuality.Regular;
			AddItem( chl );
			...
			pla.Crafter = this;
			pla.Quality = CraftQuality.Regular;
			AddItem( pla );
	...
	public class DummyFence : Dummy
	{
		...
		public DummyFence() : base(AIType.AI_Melee, FightMode.Closest, 15, 1, 0.2, 0.6)
		{
			...
			ssp.Movable = true;
			ssp.Crafter = this;
			ssp.Quality = CraftQuality.Regular;
			AddItem( ssp );
	...
	public class DummySword : Dummy
	{
		...
		public DummySword() : base(AIType.AI_Melee, FightMode.Closest, 15, 1, 0.2, 0.6)
		{
			...
			kat.Crafter = this;
			kat.Movable = true;
			kat.Quality = CraftQuality.Regular;
			AddItem( kat );
	...
	public class DummyStun : Dummy
	{
		...
		public DummyStun() : base(AIType.AI_Mage, FightMode.Closest, 15, 1, 0.2, 0.6)
		{
			...
			lea.Crafter = this;
			lea.Quality = CraftQuality.Regular;
			AddItem( lea );
			...
			lec.Crafter = this;
			lec.Quality = CraftQuality.Regular;
			AddItem( lec );
			...
			leg.Crafter = this;
			leg.Quality = CraftQuality.Regular;
			AddItem( leg );
			...
			lel.Crafter = this;
			lel.Quality = CraftQuality.Regular;
			AddItem( lel );
